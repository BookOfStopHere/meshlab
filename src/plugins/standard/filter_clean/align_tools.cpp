...
#include <plugins/standard/editalign/align/align_parameter.h>
#include <plugins/standard/editalign/meshtree.h>
#include <plugins/standard/editalign/align/AlignPair.h>
		...
		QWidget *parentWidget, bool confirm)
{
	...
	if(useMarkers || useICP)
	{
		...
		//taken from meshlab/src/plugins/standard/meshfilter/meshfilter.cpp
